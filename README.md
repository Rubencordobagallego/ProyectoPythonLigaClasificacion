...
Este proyecto tiene como objetivo crear un programa en Python que lea el archivo liga.csv correspondiente a los resultados de la temporada 2015-2016 y genere la clasificación final de la liga. El trabajo se realizará en grupo y es obligatorio usar un repositorio en GitHub. En este documento debe aparecer claramente indicado qué miembro del grupo realizará cada una de las funciones. Una vez creado el repositorio deben añadirse como colaboradores todos los integrantes del grupo y el profesor cfergar586 con permisos de edición.
